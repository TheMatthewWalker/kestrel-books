...
## Fixed: month-end drift

Both the period-end schedules and the recurring invoice templates stepped forward
one period from the *last* run date, which clamps permanently: a schedule starting
